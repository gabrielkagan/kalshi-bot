...
bot/_impl.py is **26,212 lines** as of 2026-05-08 (post-Bit-3.2 helper extraction; Bit 3.1 moved ~1,200 lines of constants to `bot/constants.py`, Bit 3.2 moved ~790 lines of helpers to `bot/helpers/*`). Class line ranges below
...
| 386–26212 | Class definitions (see table below). One module-level `def discover_active_windows()` sits in the body region between SettlementTracker's class body and the MainLoop class def at line 24216; it ships with MainLoop in Bit 9.3. |

### Class-body end vs class-range note

The class table below uses *next-class-start − 1* as the range end. So
`SettlementTracker 23037–24215` includes the inter-class
...
Generated 2026-05-08 from `grep -nE '^class ' bot/_impl.py` (post-Bit-3.2 helper extraction).

| Lines | Class | Size |
|---|---|---|
| 386–738 | `KalshiClient` | 353 |
| 739–801 | `Logger` | 63 |
| 802–1050 | `TelegramNotifier` | 249 |
| 1051–3620 | `StateManager` | 2570 |
| 3621–3942 | `CoinbaseFeed` | 322 |
| 3943–3954 | `OrderbookSchemaError` | 12 |
| 3955–5724 | `KalshiFeed` | 1770 |
| 5725–5805 | `DeribitDVOLFetcher` | 81 |
| 5806–6133 | `CrossExchangeFeed` | 328 |
| 6134–6210 | `CoinGlassFetcher` | 77 |
| 6211–6332 | `OrderFlowEngine` | 122 |
| 6333–6493 | `KalshiOrderFlowTracker` | 161 |
| 6494–7453 | `VolatilityEngine` | 960 |
| 7454–7656 | `ProbabilityEngine` | 203 |
| 7657–8666 | `CalibrationEngine` | 1010 |
| 8667–17746 | `OpportunityScanner` | 9080 |
| 17747–23036 | `OrderExecutor` | 5290 |
| 23037–24215 | `SettlementTracker` | 1179 |
| 24216–26212 | `MainLoop` | 1997 |

## Project file map (root, 2026-05-05)

Live trading process:
- `bot/_impl.py` — main bot, all trading logic (26,212 lines post-Bit-3.2)
...
- Sprint 3 → constants + helpers extracted to `bot/constants.py` + `bot/helpers/*` (Bit 3.1 + Bit 3.2 SHIPPED 2026-05-08; Bit 3.3 calibration-pipeline doc resync remaining)
