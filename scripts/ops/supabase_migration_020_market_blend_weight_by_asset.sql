...
--   {BTC:0.10, ETH:0.20, SOL:0.80, XRP:0.90} at the 15M consumer sites.
...
ALTER TABLE public.calibration_snapshots
  -- P2.1.d per-asset 15M blend weights (BTC 0.10, ETH 0.20, SOL 0.80,
  -- XRP 0.90; HYPE/DOGE shadow paths read the scalar `market_blend_weight`
  -- column instead).
