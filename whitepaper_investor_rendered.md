...
\begin{metricbox}
\textbf{Live trading results (auto-updated; last refresh 2026-04-29T15:20:21Z):}
\begin{itemize}
\item \textbf{3,125} settled trades with a \textbf{92.8\%} win rate (2,899W / 224L / 2 breakeven)
\item Cumulative live P\&L: \textbf{\$745.18}
...
| **Settled trades** | 3,125 (2,899W / 224L / 2 BE) |
| **Win rate** | 92.8\% |
| **Cumulative P&L** | $745.18 |
