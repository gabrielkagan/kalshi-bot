...
\begin{metricbox}
\textbf{Live trading results (as of 2026-04-26T16:35:12Z):}
\begin{itemize}
\item \textbf{2,914} settled trades with a \textbf{93.2\%} win rate (2,715W / 199L)
...
| **Settled trades** | 2,914 |
| **Win rate** | 93.2\% (2,715W / 199L) |
