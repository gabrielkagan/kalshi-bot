...
\begin{metricbox}
\textbf{Live trading results (auto-updated; last refresh 2026-04-29T16:23:11Z):}
\begin{itemize}
\item \textbf{3,129} settled trades with a \textbf{92.8\%} win rate (2,903W / 224L / 2 breakeven)
\item Cumulative live P\&L: \textbf{\$749.97}
...
| **Settled trades** | 3,129 (2,903W / 224L / 2 BE) |
| **Win rate** | 92.8\% |
| **Cumulative P&L** | $749.97 |
