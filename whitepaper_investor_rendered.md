...
\begin{metricbox}
\textbf{Live trading results (auto-updated; last refresh 2026-04-27T10:19:47Z):}
\begin{itemize}
\item \textbf{2,972} settled trades with a \textbf{93.0\%} win rate (2,764W / 206L / 2 breakeven)
\item Cumulative live P\&L: \textbf{\$821.73}
...
| **Settled trades** | 2,972 (2,764W / 206L / 2 BE) |
| **Win rate** | 93.0\% |
| **Cumulative P&L** | $821.73 |
