...
\begin{metricbox}
\textbf{Live trading results (auto-updated; last refresh 2026-04-29T17:36:23Z):}
\begin{itemize}
\item \textbf{3,134} settled trades with a \textbf{92.8\%} win rate (2,907W / 225L / 2 breakeven)
\item Cumulative live P\&L: \textbf{\$708.99}
...
| **Settled trades** | 3,134 (2,907W / 225L / 2 BE) |
| **Win rate** | 92.8\% |
| **Cumulative P&L** | $708.99 |
