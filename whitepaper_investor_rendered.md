...
\begin{metricbox}
\textbf{Live trading results (auto-updated; last refresh 2026-04-27T11:02:09Z):}
\begin{itemize}
\item \textbf{2,973} settled trades with a \textbf{93.0\%} win rate (2,765W / 206L / 2 breakeven)
\item Cumulative live P\&L: \textbf{\$821.81}
...
| **Settled trades** | 2,973 (2,765W / 206L / 2 BE) |
| **Win rate** | 93.0\% |
| **Cumulative P&L** | $821.81 |
