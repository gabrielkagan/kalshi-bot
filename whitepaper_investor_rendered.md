...
\begin{metricbox}
\textbf{Live trading results (as of 2026-04-26T17:37:18Z):}
\begin{itemize}
\item \textbf{2,916} settled trades with a \textbf{93.2\%} win rate (2,717W / 199L)
...
| **Settled trades** | 2,916 |
| **Win rate** | 93.2\% (2,717W / 199L) |
