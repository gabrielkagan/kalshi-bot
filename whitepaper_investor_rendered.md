...
\begin{metricbox}
\textbf{Live trading results (auto-updated; last refresh 2026-04-29T16:49:24Z):}
\begin{itemize}
\item \textbf{3,131} settled trades with a \textbf{92.8\%} win rate (2,905W / 224L / 2 breakeven)
\item Cumulative live P\&L: \textbf{\$754.95}
...
| **Settled trades** | 3,131 (2,905W / 224L / 2 BE) |
| **Win rate** | 92.8\% |
| **Cumulative P&L** | $754.95 |
