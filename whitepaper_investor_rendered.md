...
\begin{metricbox}
\textbf{Live trading results (auto-updated; last refresh 2026-04-29T20:23:10Z):}
\begin{itemize}
\item \textbf{3,144} settled trades with a \textbf{92.7\%} win rate (2,916W / 226L / 2 breakeven)
\item Cumulative live P\&L: \textbf{\$611.94}
...
| **Settled trades** | 3,144 (2,916W / 226L / 2 BE) |
| **Win rate** | 92.7\% |
| **Cumulative P&L** | $611.94 |
