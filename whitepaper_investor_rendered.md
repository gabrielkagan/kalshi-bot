...
\begin{metricbox}
\textbf{Live trading results (auto-updated; last refresh 2026-04-26T18:37:51Z):}
\begin{itemize}
\item \textbf{2,921} settled trades with a \textbf{93.2\%} win rate (2,722W / 197L / 2 breakeven)
\item Cumulative live P\&L: \textbf{\$999.65}
...
| **Settled trades** | 2,921 (2,722W / 197L / 2 BE) |
| **Win rate** | 93.2\% |
| **Cumulative P&L** | $999.65 |
