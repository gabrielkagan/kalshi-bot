...
Real caller imports (3 sites):
  ...
  - tests/test_spx_price_feed.py:11 (`import spx_engine`)
  - tests/test_spx_price_feed.py:12 (`from spx_engine import (...)`)

Path-literal refs (>= 9 sites):
  - scripts/pre_deploy_check.sh:18 (`for f in ... spx_engine.py ...`)
  - README.template.md:222 (file-tree)
  - tests/test_insert_schema_parity.py:110 (parametrize list — opens file)
  - tests/test_product_type_enum.py:51 (parametrize list — opens file)
  - tests/test_db_signatures.py:40,310 (parametrize lists — opens file × 2)
  - tests/test_call_sites.py:32 (parametrize list — opens file)
  - tests/test_regression.py:561 (parametrize list — opens file)
...
_PATH_LITERAL_ALLOW = {
    "tests/test_sprint_10_1b_spx_engine_move.py",      # this file
    "tests/test_sprint_10_1a_sports_data_move.py",     # mentions 10.1b roadmap
    "tests/CLAUDE.md",
    "kb/decisions",
    "kb/concepts",
    "kb/failures",
