...
Real caller imports (6 sites):
  ...
  - tests/test_extended_features.py:341 (`from sports_engine import GameState, ComebackSignal`)
  - tests/test_sports_ask_depth_int.py:39,74 (`import sports_engine` × 2)
  - tests/test_regression.py:2486,2499,2506 (`from sports_engine import _parse_orderbook` × 3)
...
Path-literal refs (~65 across):
  ...
  - tests/test_call_sites.py (ENGINE_FILES + ALLOWED_RAW_INSERTERS + file-open)
  - tests/test_db_signatures.py (2 sites)
  - tests/test_db_writer_registry.py (parametrize)
  - tests/test_insert_schema_parity.py (9 sites incl. ALLOWED_RAW_INSERTERS + file-open at L272)
  - tests/test_product_type_enum.py (parametrize)
  - tests/test_regression.py (multiple incl. CRITICAL_FILES)
  - tests/test_sports_ask_depth_int.py (alias + file-open at L91)
  - tests/test_orderbook_logging_schema.py (prose)
  - tests/test_15m_silence_alert.py (prose, cosmetic)
  - tests/test_sprint_10_1b_spx_engine_move.py + tests/test_sprint_10_1c_weather_engine_move.py
...
_PATH_LITERAL_ALLOW = {
    "tests/test_sprint_10_1d_sports_engine_move.py",
    "tests/test_sprint_10_1c_weather_engine_move.py",
    "tests/test_sprint_10_1b_spx_engine_move.py",
