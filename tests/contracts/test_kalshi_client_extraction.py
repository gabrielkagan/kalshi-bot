...
Mirrors tests/contracts/test_notifier_extraction.py (Bit 4.2) and
tests/contracts/test_logger_extraction.py (Bit 4.1).
...
def test_writes_are_not_breaker_wrapped():
    ...
    Mirrors tests/integration/test_kalshi_client_breakers.py::TestKalshiClientWritesAreNotWrapped
