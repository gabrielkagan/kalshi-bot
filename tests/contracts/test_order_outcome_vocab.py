...
BOT_PY = pathlib.Path(__file__).resolve().parents[2] / "bot/_impl.py"
EXECUTOR_PY = pathlib.Path(__file__).resolve().parents[2] / "bot/executor.py"
SETTLEMENT_PY = pathlib.Path(__file__).resolve().parents[2] / "bot/settlement.py"
MAIN_LOOP_PY = pathlib.Path(__file__).resolve().parents[2] / "bot/main_loop.py"
