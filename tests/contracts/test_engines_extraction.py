...
bot/engines/ subpackage. Mirrors tests/contracts/test_feeds_extraction.py (Bit 4.5a/4.5b)
and tests/contracts/test_fetchers_extraction.py (Bit 4.4).
...
tests in tests/contracts/test_fetchers_extraction.py and tests/contracts/test_feeds_extraction.py
...
def test_volatility_identity_through_bot_impl():
    ...
    annotation (`vol: VolatilityEngine`), and tests/integration/test_vol_engine.py
...
def test_volatility_engine_static_methods_remain_static(method_name):
    ...
    tests/integration/test_vol_engine.py calls these as `VolatilityEngine._method(...)`
    ...
    assert "staticmethod" in decorator_names, (
        ...
        f"tests/integration/test_vol_engine.py calls it as `VolatilityEngine.{method_name}(...)` "
...
def test_probability_identity_through_bot_proxy():
    ...
    canonical class object. tests/integration/test_probability_engine.py uses
...
def test_probability_engine_methods_remain_static(method_name):
    """All 5 ProbabilityEngine methods are @staticmethod. tests/integration/test_probability_engine.py
    ...
    assert "staticmethod" in decorator_names, (
        ...
        f"both bot/_impl.py call sites and tests/integration/test_probability_engine.py."
    )
...
def test_calibration_identity_through_bot_proxy():
    ...
    canonical class object. tests/integration/test_calibration_engine.py uses
