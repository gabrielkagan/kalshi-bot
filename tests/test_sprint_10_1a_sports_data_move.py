...
5 things must hold post-Bit:
  ...
  3. All 5 caller import sites updated:
     ...
     - tests/test_extended_features.py:~342 (method-body)
     - tests/test_step3_soccer_reenabled.py:~45 (method-body)
...
# sweep precise.
_PATH_LITERAL_ALLOW = {
    "tests/test_sprint_10_1a_sports_data_move.py",      # this file
