...
Mirrors the bleed-cell pattern at tests/integration/test_bleed_cell_blocks.py: module-level
...
def _import_bot():
    ...
    # Mock heavy deps (mirrors tests/integration/test_weather_no_side.py prelude)
