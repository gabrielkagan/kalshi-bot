...
Threading invariant (existing pin in tests/integration/test_cal_mlp_invariants.py):
...
Mirrors patterns from tests/integration/test_state_extraction.py (AST walks against
bot/_impl.py) and tests/integration/test_cal_mlp_invariants.py (sys.path setup +
...
# header + tests/integration/test_cal_mlp_invariants.py:18)
...
def test_predictor_init_zero_io_post_relocation():
    ...
    Companion to tests/integration/test_cal_mlp_invariants.py::test_cal_mlp_predictor_init_zero_io
