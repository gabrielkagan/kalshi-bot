...
Mirrors tests/integration/test_settlement_extraction.py (Bit 9.2 clean leaf) +
tests/integration/test_main_loop_extraction.py (Bit 9.3 marker-collapse pattern).
"""
