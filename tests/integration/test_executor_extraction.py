...
Mirrors tests/integration/test_scanner_extraction.py (Bit 8.1 path-A++) +
tests/integration/test_state_extraction.py (Bit 7.1 path-A++) +
tests/contracts/test_engines_extraction.py (Bit 6.1/6.2/6.3).
"""
...
def test_bot_impl_does_NOT_have_l81_alias_import_post_bit_9_2():
    ...
    See tests/integration/test_settlement_extraction.py::test_l81_alias_import_dropped_from_bot_impl
