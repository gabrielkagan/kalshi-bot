...
class TestCancel404PartialFillLabeling(unittest.TestCase):
    ...
    `order_lifecycle_snapshots`. See tests/contracts/test_order_outcome_vocab.py.
    """
...
class TestKalshiBreakerSuccessOnCancel404Sentinel(unittest.TestCase):
    ...
    `tests/integration/test_kalshi_client_breakers.py::test_cancel_order_not_wrapped`
