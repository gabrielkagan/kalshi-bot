...
def _read_bot():
    ...
    method bodies / DDL (in bot/state.py post-Bit-7.1) AND tests that look
    for OpportunityScanner / scan-loop patterns (still in bot/_impl.py) all
    find their targets in the concatenated source.
    """
    impl = ""
    ...
    _executor_path = os.path.join(os.path.dirname(BOT_PATH), "executor.py") if "BOT_PATH" in globals() else os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "bot", "executor.py")
    ...
    _settlement_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "bot", "settlement.py")
    ...
    _main_loop_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "bot", "main_loop.py")
