...
invariant. This module enforces three contracts:
    ...
    C. Raw-inserter coverage.
       Files in tests/contracts/test_call_sites.py::ALLOWED_RAW_INSERTERS that
...
# canonical definition lives in tests/contracts/test_call_sites.py:184; this set
...
def test_allowed_raw_inserters_set_matches_canonical():
    ...
    canonical set in tests/contracts/test_call_sites.py. If they drift, a future
    ...
    MAJOR-1 fix.
    """
    from tests.contracts.test_call_sites import (
    ...
    assert canonical == ALLOWED_RAW_INSERTERS, (
        ...
        f"  tests/contracts/test_call_sites.py:184 → {sorted(canonical)}\n"
        f"  tests/integration/test_insert_schema_parity.py:54 → "
...
class TestRawInserterDataProvenance:
    ...
    def test_raw_inserts_carry_data_provenance(self, fname):
        ...
        assert inserts, (
            ...
            f"(remove from ALLOWED_RAW_INSERTERS in tests/contracts/test_call_sites.py)."
        )
