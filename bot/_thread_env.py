...
The bot's CRITICAL contract: bot/_impl.py's first executable imports are
    import os
    import sys
    import bot._thread_env  # this module — sets OMP_NUM_THREADS=1 etc.
...
PRIMARY enforcement: this module runs on every bot/_impl.py boot regardless of
