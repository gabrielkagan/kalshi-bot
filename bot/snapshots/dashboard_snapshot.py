    ...
    def _build_snapshot(self, db_conn) -> Dict[str, Any]:
        ...
        try:
            ...
            snap["trading_config"] = {
                ...
                # P2.1.d (2026-05-13) + P2.3 (2026-05-14) + P2.4 (2026-05-19):
                # per-asset 15M blend weights replace the scalar for all 7
                # production 15M assets at runtime. Unknown assets fall back
                # to the scalar above. 14d Brier-monitored soak reads from
                # this field.
        ...
        try:
            ...
            if koft:
                ...
                _hourly_pfx = ("KXBTCD", "KXETHD", "KXSOLD", "KXXRPD", "KXHYPED", "KXDOGED", "KXBNBD", "KXADAD", "KXBCHD", "KXNEARD", "KXZECD")
                per_ticker = {}
