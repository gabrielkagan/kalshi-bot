...
CURRENT_CONFIG = {
    ...
    "BNB_MIN_ENTRY_PRICE": 90,
    "XRP_15M_SHADOW": False,
    "HYPE_15M_SHADOW": False,
    "DOGE_15M_SHADOW": False,
    "BNB_15M_SHADOW": False,
    "MAX_ENTRY_PRICE": 99,
    "MIN_EDGE_BY_PRICE": "97c→1.0%, 95c→0.75%, 93c→0.5%, 91c→0.2%, 89c→0.25%, default→0.25%",
    "MARKET_BLEND_W": 0.40,
    "MARKET_BLEND_W_BY_ASSET": "{BTC:0.10, ETH:0.20, SOL:0.80, XRP:0.90, HYPE:0.80, DOGE:0.60, BNB:0.20}  # P2.3 live promotion 2026-05-14 (86b9xv66a). P2.4 BNB live promotion 2026-05-19 (86b9zmj37) — Brier sweep argmin 0.20 at n=721, matches ETH pattern.",
