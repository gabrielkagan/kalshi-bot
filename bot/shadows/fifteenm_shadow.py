...
DEFAULT_TEMPERATURES = {"BTC": 1.15, "ETH": 1.25, "SOL": 1.05, "XRP": 1.30, "HYPE": 1.00, "DOGE": 1.00, "BNB": 1.00}
# Per-asset market blend weight (higher = more market, less model)
DEFAULT_BLEND_W = {"BTC": 0.50, "ETH": 0.50, "SOL": 0.45, "XRP": 0.60, "HYPE": 0.50, "DOGE": 0.50, "BNB": 0.50}
# Per-asset overconfidence bias (pp to subtract before Kelly)
DEFAULT_DEBIAS = {"BTC": 0.02, "ETH": 0.04, "SOL": 0.01, "XRP": 0.05, "HYPE": 0.00, "DOGE": 0.00, "BNB": 0.00}
...
class EGARCHGatingApproach:
    ...
    def _asset_to_idx(asset: str) -> int:
        return {"BTC": 0, "ETH": 1, "SOL": 2, "XRP": 3, "HYPE": 4, "DOGE": 5, "BNB": 6}.get(asset, -1)
