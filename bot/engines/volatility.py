...
``tests/test_vol_engine.py`` via ``from bot import VolatilityEngine``
(proxy chain: ``bot._BotProxy → bot._impl.VolatilityEngine →
bot.engines.VolatilityEngine → bot.engines.volatility.VolatilityEngine``).
"""
