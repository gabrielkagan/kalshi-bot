...
Automated trading platform for Kalshi prediction markets. The core engine trades 15-minute cryptocurrency contracts (BTC, ETH, SOL, XRP, HYPE, DOGE, BNB — all seven live post P2.4 promotion 2026-05-19; HYPE/DOGE T4 was P2.3 2026-05-14; BNB T4 was P2.4 2026-05-19) live, with several adjacent strategies layered on top: decided contracts, late-window momentum, weekend/overnight discounts, and a near-expiry low-price entry. Adjacent products (S&P 500 intraday, daily weather temperature across {{WEATHER_CITY_COUNT}} US cities, and live sports outcomes across {{SPORTS_LEAGUE_COUNT}} leagues) run in observation or 1-contract verification mode while their CalEngines train.
