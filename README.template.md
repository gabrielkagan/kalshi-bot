...
Automated trading platform for Kalshi prediction markets. Core engine trades 15-minute cryptocurrency contracts (BTC, ETH, SOL, XRP) using microstructure-aware volatility models. Expanding into S&P 500 intraday, daily weather temperature ({{WEATHER_CITY_COUNT}} US cities), and live sports outcomes ({{SPORTS_LEAGUE_COUNT}} leagues) --- all in shadow mode collecting calibration data.
