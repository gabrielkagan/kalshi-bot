...
MARKET_CONFIGS: Dict[str, MarketTypeConfig] = {
    ...
    "hourly": MarketTypeConfig(
        ...
        fee_multiplier_taker=0.07,
        fee_multiplier_maker=0.0,  # Kalshi charges $0 on maker fills
        excluded_assets=frozenset({"SOL", "XRP", "HYPE", "DOGE"}),  # BTC+ETH only; HYPE/DOGE T1 shadow until T4 — lock-step with bot/constants.py:HOURLY_EXCLUDED_ASSETS (assertion at :284 will crash startup on mismatch)
