...
\begin{metricbox}
\textbf{Live trading results (auto-updated; last refresh 2026-05-17T10:48:37Z):}
\begin{itemize}
\item \textbf{4,351} settled trades with a \textbf{92.5\%} win rate (4,024W / 325L / 2 breakeven)
...
| **Settled trades** | 4,351 (4,024W / 325L / 2 BE) |
| **Win rate** | 92.5\% |
