...
\begin{metricbox}
\textbf{Live trading results (auto-updated; last refresh 2026-05-16T22:21:01Z):}
\begin{itemize}
\item \textbf{4,293} settled trades with a \textbf{92.5\%} win rate (3,969W / 322L / 2 breakeven)
...
| **Settled trades** | 4,293 (3,969W / 322L / 2 BE) |
| **Win rate** | 92.5\% |
