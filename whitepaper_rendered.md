...
| **Settled trades** | 4,208 (3,886W / 320L / 2 breakeven) |
| **Win rate** | 92.3\% |
...
|---|---|---|---|
| 15M main (Kelly-sized) | 1,698 | 1,533 W / 165 L | 90.3\% |
| Decided contracts | 310 | 300 W / 10 L | 96.8\% |
| Weekend discount | 175 | 165 W / 10 L | 94.3\% |
| Overnight discount | 100 | 96 W / 4 L | 96.0\% |
| LPNE (BTC 80–87¢ near-expiry) | 5 | 5 W / 0 L | 100.0\% |
| Weather NO (1-contract verification) | 167 | 64 W / 103 L | 38.3\% |
...
- **Brier (all live candidates)** — measures the **model's** calibration on every opportunity that passed the live-candidate filter, whether or not it filled: 0.0410 overall, 0.0300 on 15M, 0.4005 on weather (side-aware: NO-side rows use $1-p_{raw}$ as the model's probability of the bot's bet winning).
- **Brier (filled trades only)** — measures the **bot's paid-decision** calibration via JOIN(settled_trades, latest matching evaluated_opportunities row), deduplicated on stacked tickers and timestamp ties: 0.0606 overall (3,999 samples), 0.0453 on 15M.

A small number of settled trades (4,208 total, of which N lack a matching EO row — see `settled_without_matching_eo` in the auto-generated stats) are excluded from filled-Brier; their model prediction was not preserved in evaluated_opportunities.
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 2,386 | 2,184 | 91.5\% | 0.0412 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 1,438 | 1,301 | 90.5\% | 0.0340 |
...
*Last updated: 2026-05-15T23:04:12Z*
