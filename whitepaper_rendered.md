...
- **Brier (all live candidates)** — measures the **model's** calibration on every opportunity that passed the live-candidate filter, whether or not it filled: 0.0415 overall, 0.0299 on 15M, 0.3946 on weather (side-aware: NO-side rows use $1-p_{raw}$ as the model's probability of the bot's bet winning).
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 2,030 | 1,864 | 91.8\% | 0.0421 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 1,082 | 981 | 90.7\% | 0.0329 |
