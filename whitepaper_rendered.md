...
| **Settled trades** | 3,740 (3,464W / 274L / 2 breakeven) |
| **Win rate** | 92.6\% |
...
- **Brier (filled trades only)** — measures the **bot's paid-decision** calibration via JOIN(settled_trades, latest matching evaluated_opportunities row), deduplicated on stacked tickers and timestamp ties: 0.0579 overall (3,545 samples), 0.0440 on 15M.

A small number of settled trades (3,740 total, of which N lack a matching EO row — see `settled_without_matching_eo` in the auto-generated stats) are excluded from filled-Brier; their model prediction was not preserved in evaluated_opportunities.
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 1,918 | 1,762 | 91.9\% | 0.0419 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 970 | 879 | 90.6\% | 0.0312 |
