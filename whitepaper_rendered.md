...
| **Settled trades** | 3,771 (3,492W / 277L / 2 breakeven) |
| **Win rate** | 92.6\% |
...
|---|---|---|---|
| 15M main (Kelly-sized) | 1,576 | 1,430 W / 146 L | 90.7\% |
...
| Weather NO (1-contract verification) | 137 | 53 W / 84 L | 38.7\% |
...
- **Brier (filled trades only)** — measures the **bot's paid-decision** calibration via JOIN(settled_trades, latest matching evaluated_opportunities row), deduplicated on stacked tickers and timestamp ties: 0.0582 overall (3,574 samples), 0.0440 on 15M.

A small number of settled trades (3,771 total, of which N lack a matching EO row — see `settled_without_matching_eo` in the auto-generated stats) are excluded from filled-Brier; their model prediction was not preserved in evaluated_opportunities.
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 1,949 | 1,790 | 91.8\% | 0.0419 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 1,001 | 907 | 90.6\% | 0.0314 |
...
*Last updated: 2026-05-09T11:55:39Z*
