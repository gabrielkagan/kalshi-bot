...
| **Settled trades** | 3,721 (3,445W / 274L / 2 breakeven) |
| **Win rate** | 92.6\% |
...
|---|---|---|---|
| 15M main (Kelly-sized) | 1,567 | 1,421 W / 146 L | 90.7\% |
...
- **Brier (filled trades only)** — measures the **bot's paid-decision** calibration via JOIN(settled_trades, latest matching evaluated_opportunities row), deduplicated on stacked tickers and timestamp ties: 0.0582 overall (3,527 samples), 0.0442 on 15M.

A small number of settled trades (3,721 total, of which N lack a matching EO row — see `settled_without_matching_eo` in the auto-generated stats) are excluded from filled-Brier; their model prediction was not preserved in evaluated_opportunities.
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 1,899 | 1,743 | 91.8\% | 0.0423 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 951 | 860 | 90.4\% | 0.0317 |
