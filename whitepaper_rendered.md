...
| **Settled trades** | 3,731 (3,455W / 274L / 2 breakeven) |
| **Win rate** | 92.6\% |
...
|---|---|---|---|
| 15M main (Kelly-sized) | 1,571 | 1,425 W / 146 L | 90.7\% |
...
- **Brier (filled trades only)** — measures the **bot's paid-decision** calibration via JOIN(settled_trades, latest matching evaluated_opportunities row), deduplicated on stacked tickers and timestamp ties: 0.0581 overall (3,537 samples), 0.0441 on 15M.

A small number of settled trades (3,731 total, of which N lack a matching EO row — see `settled_without_matching_eo` in the auto-generated stats) are excluded from filled-Brier; their model prediction was not preserved in evaluated_opportunities.
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 1,909 | 1,753 | 91.8\% | 0.0421 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 961 | 870 | 90.5\% | 0.0314 |
...
*Last updated: 2026-05-08T22:16:33Z*
