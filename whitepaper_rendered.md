...
| **Settled trades** | 3,371 (3,124W / 245L / 2 breakeven) |
| **Win rate** | 92.7\% |
...
| Weather NO (1-contract verification) | 106 | 43 W / 63 L | 40.6\% |
...
- **Brier (filled trades only)** — measures the **bot's paid-decision** calibration via JOIN(settled_trades, latest matching evaluated_opportunities row), deduplicated on stacked tickers and timestamp ties: 0.0582 overall (3,182 samples), 0.0457 on 15M.

A small number of settled trades (3,371 total, of which N lack a matching EO row — see `settled_without_matching_eo` in the auto-generated stats) are excluded from filled-Brier; their model prediction was not preserved in evaluated_opportunities.
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 1,549 | 1,422 | 91.8\% | 0.0451 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 601 | 539 | 89.7\% | 0.0332 |
...
*Last updated: 2026-05-03T21:26:22Z*
