...
- **Brier (all live candidates)** — measures the **model's** calibration on every opportunity that passed the live-candidate filter, whether or not it filled: 0.0430 overall, 0.0306 on 15M, 0.3954 on weather (side-aware: NO-side rows use $1-p_{raw}$ as the model's probability of the bot's bet winning).
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 1,501 | 1,377 | 91.7\% | 0.0452 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 553 | 494 | 89.3\% | 0.0319 |
...
*Last updated: 2026-05-02T19:53:41Z*
