...
| **Settled trades** | 3,777 (3,497W / 278L / 2 breakeven) |
| **Win rate** | 92.6\% |
...
| Weekend discount | 156 | 146 W / 10 L | 93.6\% |
...
- **Brier (filled trades only)** — measures the **bot's paid-decision** calibration via JOIN(settled_trades, latest matching evaluated_opportunities row), deduplicated on stacked tickers and timestamp ties: 0.0583 overall (3,580 samples), 0.0439 on 15M.

A small number of settled trades (3,777 total, of which N lack a matching EO row — see `settled_without_matching_eo` in the auto-generated stats) are excluded from filled-Brier; their model prediction was not preserved in evaluated_opportunities.
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 1,955 | 1,795 | 91.8\% | 0.0418 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 1,007 | 912 | 90.6\% | 0.0314 |
...
*Last updated: 2026-05-09T12:59:41Z*
