...
| **Settled trades** | 3,410 (3,161W / 247L / 2 breakeven) |
| **Win rate** | 92.7\% |
...
|---|---|---|---|
| 15M main (Kelly-sized) | 1,459 | 1,323 W / 136 L | 90.7\% |
...
| Weather NO (1-contract verification) | 109 | 44 W / 65 L | 40.4\% |
...
- **Brier (filled trades only)** — measures the **bot's paid-decision** calibration via JOIN(settled_trades, latest matching evaluated_opportunities row), deduplicated on stacked tickers and timestamp ties: 0.0578 overall (3,218 samples), 0.0452 on 15M.

A small number of settled trades (3,410 total, of which N lack a matching EO row — see `settled_without_matching_eo` in the auto-generated stats) are excluded from filled-Brier; their model prediction was not preserved in evaluated_opportunities.
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 1,588 | 1,459 | 91.9\% | 0.0443 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 640 | 576 | 90.0\% | 0.0322 |
...
*Last updated: 2026-05-04T12:20:36Z*
