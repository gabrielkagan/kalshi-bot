...
| **Settled trades** | 4,250 (3,926W / 322L / 2 breakeven) |
| **Win rate** | 92.4\% |
...
| Weekend discount | 182 | 172 W / 10 L | 94.5\% |
| Overnight discount | 100 | 96 W / 4 L | 96.0\% |
| LPNE (BTC 80–87¢ near-expiry) | 5 | 5 W / 0 L | 100.0\% |
| Weather NO (1-contract verification) | 170 | 66 W / 104 L | 38.8\% |
...
- **Brier (filled trades only)** — measures the **bot's paid-decision** calibration via JOIN(settled_trades, latest matching evaluated_opportunities row), deduplicated on stacked tickers and timestamp ties: 0.0605 overall (4,039 samples), 0.0452 on 15M.

A small number of settled trades (4,250 total, of which N lack a matching EO row — see `settled_without_matching_eo` in the auto-generated stats) are excluded from filled-Brier; their model prediction was not preserved in evaluated_opportunities.
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 2,428 | 2,224 | 91.6\% | 0.0413 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 1,480 | 1,341 | 90.6\% | 0.0343 |
...
*Last updated: 2026-05-16T11:36:42Z*
