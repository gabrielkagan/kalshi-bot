...
| **Settled trades** | 3,809 (3,528W / 279L / 2 breakeven) |
| **Win rate** | 92.6\% |
...
- **Brier (filled trades only)** — measures the **bot's paid-decision** calibration via JOIN(settled_trades, latest matching evaluated_opportunities row), deduplicated on stacked tickers and timestamp ties: 0.0580 overall (3,611 samples), 0.0438 on 15M.

A small number of settled trades (3,809 total, of which N lack a matching EO row — see `settled_without_matching_eo` in the auto-generated stats) are excluded from filled-Brier; their model prediction was not preserved in evaluated_opportunities.
...
|---|---|---|---|---|
| Since 2026-04-11T20:43Z (loss-burst cooldown + weather NO live) | 1,987 | 1,826 | 91.9\% | 0.0412 |
| Since 2026-04-23T23:46Z (WS schema fix `0ddcaf8`) | 1,039 | 943 | 90.8\% | 0.0307 |
...
*Last updated: 2026-05-10T11:08:18Z*
