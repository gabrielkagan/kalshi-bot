...
- [[decisions/d3-0-silver-foundations-plan.md]] - D3.0 silver layer foundations (ticket 86b9zxc6t). First Bit of Phase 2 (Silver). Off-VPS DuckDB ETL on operator Mac via launchd nightly. 5 Tier-1 sources normalized to Parquet under `silver/v1/<source>/utc_date=YYYY-MM-DD/`. Direct-DuckDB ships D3.0; dbt-project layering deferred to D3.0-fu1.
