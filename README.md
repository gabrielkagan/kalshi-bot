...
| Metric | Value |
|--------|-------|
| Markets evaluated | 169,538 |
| Observation period | 2026-02-22 to 2026-05-02 |
| Filter pass rate | 3.9\% (6,577 of 169,538) |
| Top rejection reason | Insufficient Edge (52,401) |
...
```
bot.py                         -- core bot logic (~26,829 lines, never rename)
