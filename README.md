...
8. **Decided contract overlay**: T1 (z <= -5, 93c+) and T2 (z <= -3, 93-96c) route to direct taker for near-certain settlements. Fixed 12.5% bankroll risk per signal.
...
|----------|--------|-------------|
| 15M crypto | **LIVE** (BTC/ETH/SOL/XRP) | STC 600-900s, price 70-85c, decided contract, relaxed edge, weekend/overnight discount, overnight LP, dip addon, XRP low-price, shadow engine A1-A4 |
