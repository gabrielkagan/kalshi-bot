...
| Metric | Value |
|--------|-------|
| Markets evaluated | 155,377 |
| Observation period | 2026-02-22 to 2026-04-27 |
| Filter pass rate | 3.8\% (5,852 of 155,377) |
| Top rejection reason | Insufficient Edge (48,396) |
| Settled trades | 2,973 (2,765 W / 206 L / 2 BE) |
| Win rate | 93.0\% |
| Live P&L | $821.81 |
...
```
bot.py                         -- core bot logic (~25,418 lines, never rename)
