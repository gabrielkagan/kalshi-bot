...
| Metric | Value |
|--------|-------|
| Markets evaluated | 186,343 |
| Observation period | 2026-02-22 to 2026-05-08 |
| Filter pass rate | 4.0\% (7,387 of 186,343) |
| Top rejection reason | Insufficient Edge (56,636) |
...
```
bot/_impl.py                         -- core bot logic (~26,147 lines, never rename)
