...
| Metric | Value |
|--------|-------|
| Markets evaluated | 171,763 |
| Observation period | 2026-02-22 to 2026-05-03 |
| Filter pass rate | 3.9\% (6,712 of 171,763) |
| Top rejection reason | Insufficient Edge (52,980) |
| Settled trades | 3,371 (3,124 W / 245 L / 2 BE) |
| Win rate | 92.7\% |
...
```
bot.py                         -- core bot logic (~27,273 lines, never rename)
