...
| Metric | Value |
|--------|-------|
| Markets evaluated | 186,658 |
| Observation period | 2026-02-22 to 2026-05-09 |
| Filter pass rate | 4.0\% (7,409 of 186,658) |
| Top rejection reason | Insufficient Edge (56,701) |
| Settled trades | 3,743 (3,467 W / 274 L / 2 BE) |
| Win rate | 92.6\% |
...
```
bot/_impl.py                         -- core bot logic (~25,628 lines, never rename)
