...
| Metric | Value |
|--------|-------|
| Markets evaluated | 186,723 |
| Observation period | 2026-02-22 to 2026-05-09 |
| Filter pass rate | 4.0\% (7,413 of 186,723) |
| Top rejection reason | Insufficient Edge (56,715) |
| Settled trades | 3,749 (3,472 W / 275 L / 2 BE) |
| Win rate | 92.6\% |
...
```
bot/_impl.py                   -- main runtime body (~25,011 lines, never rename)
