...
| Metric | Value |
|--------|-------|
| Markets evaluated | 186,760 |
| Observation period | 2026-02-22 to 2026-05-09 |
| Filter pass rate | 4.0\% (7,415 of 186,760) |
| Top rejection reason | Insufficient Edge (56,724) |
...
```
bot/_impl.py                         -- core bot logic (~25,011 lines, never rename)
