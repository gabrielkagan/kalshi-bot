...
| Metric | Value |
|--------|-------|
| Markets evaluated | 186,166 |
| Observation period | 2026-02-22 to 2026-05-08 |
| Filter pass rate | 4.0\% (7,374 of 186,166) |
| Top rejection reason | Insufficient Edge (56,598) |
| Settled trades | 3,725 (3,449 W / 274 L / 2 BE) |
| Win rate | 92.6\% |
...
```
bot/_impl.py                         -- core bot logic (~26,212 lines, never rename)
