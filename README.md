...
| Metric | Value |
|--------|-------|
| Markets evaluated | 171,330 |
| Observation period | 2026-02-22 to 2026-05-03 |
| Filter pass rate | 3.9\% (6,677 of 171,330) |
| Top rejection reason | Insufficient Edge (52,874) |
...
```
bot.py                         -- core bot logic (~27,080 lines, never rename)
