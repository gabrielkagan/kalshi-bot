...
| Metric | Value |
|--------|-------|
| Markets evaluated | 169,556 |
| Observation period | 2026-02-22 to 2026-05-02 |
| Filter pass rate | 3.9\% (6,578 of 169,556) |
| Top rejection reason | Insufficient Edge (52,405) |
...
```
bot.py                         -- core bot logic (~26,900 lines, never rename)
