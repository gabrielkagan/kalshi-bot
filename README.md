...
| Metric | Value |
|--------|-------|
| Markets evaluated | 169,602 |
| Observation period | 2026-02-22 to 2026-05-02 |
| Filter pass rate | 3.9\% (6,581 of 169,602) |
| Top rejection reason | Insufficient Edge (52,414) |
...
```
bot.py                         -- core bot logic (~26,954 lines, never rename)
