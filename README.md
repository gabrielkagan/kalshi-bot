...
| Metric | Value |
|--------|-------|
| Markets evaluated | 186,796 |
| Observation period | 2026-02-22 to 2026-05-09 |
| Filter pass rate | 4.0\% (7,418 of 186,796) |
| Top rejection reason | Insufficient Edge (56,731) |
| Settled trades | 3,750 (3,473 W / 275 L / 2 BE) |
| Win rate | 92.6\% |
...
```
bot/_impl.py                         -- core bot logic (~25,026 lines, never rename)
